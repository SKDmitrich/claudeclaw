...
- category: определи по описанию (СДЭК/почта/ПЭК/доставка → Логистические расходы, WB/самовыкуп → Самовыкупы, фото/съемка → Фотоконтент, пленка/коробки → Упаковка, подписка/сервис → ПО и сервисы, брак → Брак). "Логистические расходы (не вх. в с/с)" используй только если явно указано что расход не входит в себестоимость
